...
public class NonDeterministicTestApplicationTests {
    ...
    public void assertDifferentVariables() {
        assertThat(hardToTestService.getUUID())
                .isEqualByComparingTo(hardToTestService.getUUID())
                .isEqualByComparingTo(UUID.nameUUIDFromBytes("IALwaysReturnTheSame".getBytes()));
        assertThat(startTime).isEqualTo(hardToTestService.getInstant());
    }
    ...
    static class DeterministricConfiguration {
        ...
        @Bean
        public HardToTestService hardToTestService(
                CurrentTimeGenerator timeGenerator, IdGenerator idGenerator) {
